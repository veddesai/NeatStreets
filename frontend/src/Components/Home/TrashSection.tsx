...
const TrashSection: React.FC = () => {
  return (
    <motion.div 
      className="p-16  dark:bg-slate-800"
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
    >
      <h1 className="font-bold text-blue-700 uppercase dark:text-yellow-400 text-center text-5xl max-lg:text-4xl">
      ...
      <h3 className="font-light text-center mt-8 text-3xl text-blue-700 dark:text-yellow-400">
